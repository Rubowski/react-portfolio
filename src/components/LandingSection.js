...
const greeting = "Hello, I'm Odysseas";
const bio1 = "Frontend developer";
const bio2 = "I build fast, thoughtful interfaces for the web";

/** Short labels — quick scan of focus; edit freely */
const focusLabels = ["Shopify", "WordPress", "React", "Performance"];
